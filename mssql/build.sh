...
readonly REQUIRED_DIR_NAME="mssql"
...
readonly DOCKER_IMAGE_TAG="${MSSQL_VERSION}"
readonly DOCKER_TAG="${DOCKER_USER}/${MSSQL_IMAGE_NAME}:${DOCKER_IMAGE_TAG}"

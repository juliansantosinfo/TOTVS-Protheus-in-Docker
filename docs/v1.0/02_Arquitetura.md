...
*   **Exposição Externa:** Apenas as portas necessárias para o usuário (ex: 23002 para Web, 1433 para SQL Management Studio) são mapeadas para o `localhost` da máquina hospedeira.

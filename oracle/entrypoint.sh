...
# DESCRIÇÃO: Ponto de entrada do container ORACLE. Inicializa a estrutura de dados 
#            e delega para o entrypoint oficial do ORACLE.
...
## 🚀 INICIALIZAÇÃO DO SERVIÇO (ENTRYPOINT OFICIAL)
  ...
  # Chama o entrypoint original do ORACLE, mantendo o PID 1 no container.
